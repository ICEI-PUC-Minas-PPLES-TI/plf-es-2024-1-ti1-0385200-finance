...
function changeUser(id, usuarioCorrente, refreshFunction) {
    ...
    usuarioCorrente.login = document.getElementById('txt_login').value;
    usuarioCorrente.senha = document.getElementById('txt_senha').value
    usuarioCorrente.nome = document.getElementById('txt_nome').value;
    usuarioCorrente.email = document.getElementById('txt_email').value;
    ...
    console.log('ID:', id);
    console.log('Usuario Corrente:', usuarioCorrente, refreshFunction);
